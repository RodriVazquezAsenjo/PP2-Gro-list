document.addEventListener("DOMContentLoaded", () => {
    ...
    updateMaxRoundsPossible(); // Initial update of max rounds possible
  });
  ...
  function endQuiz() {
    ...
    contentContainer.innerHTML = `<h3>Quiz ended! You got ${document.getElementById("correct-count").innerText} out of ${maxNumberOfQuestions} correct!</h3>`;
